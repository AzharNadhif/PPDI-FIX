...
<body>
    ...
    <!-- CONTAINER -->
    <div class="container">
        <h2> PPDI Apresiasi Pekan HAM Kota Bogor, Harap Dibangun Panti Disabilitas</h2>
        <!-- BANNER -->
        <div class="shadow " style="border-radius: 25px;">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="banner">
                    <img class="d-block w-100" src="artikel/Artikel Terbaru.jpg" alt="First slide">
                </div>
        </div>
        </div>
        <!-- AKHIR BANNER -->
        ...
        <br><br>
        <h6>12/12/2022 - Oleh Yosep Awaludin</h6>
        <br>
        <div class="paragraf">
            <p><span>
                Ketua Perkumpulan Penyandang Disabilitas Indonesia (PPDI) Kota Bogor, Hasan Basri sangat mengapresiasi acara Pekan Hak Asasi Manusia (HAM) Kota Bogor yang menurutnya sangat luar biasa. <br><br>
 ...
 <!-- Footer -->
    <footer class="footer">
        ...
        <div class="footer-right">
            ...
            <div class="button">
                <a class="btn btn-primary" href="#" role="button" style="border-radius: 25px;"> Subscribe </a>
            </div>
